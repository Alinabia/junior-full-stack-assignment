...
using AutoMapper;
using LeanTask.Application.Exceptions;
...
using LeanTask.Infrastructure.Specifications;
...
namespace LeanTask.Infrastructure.Services.Identity
{
    public class UserService : IUserService
    {
        ...
        private async Task<string> SendVerificationEmail(LeanUser user, string origin)
        {
        ...
        public async Task<IResult> UpdateRolesAsync(UpdateUserRolesRequest request)
        {
            ...
            if (user.Email == "admin@blazorLean.com")
            {
        ...
        public async Task<string> ExportToExcelAsync(string searchString = "")
        {
            ...
            var result = await _excelService.ExportAsync(users, sheetName: _localizer["Users"],
                mappers: new Dictionary<string, Func<LeanUser, object>>
                {

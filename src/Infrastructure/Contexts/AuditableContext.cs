using LeanTask.Application.Enums;
...
namespace LeanTask.Infrastructure.Contexts
{
    public abstract class AuditableContext : IdentityDbContext<LeanUser, LeanRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, LeanRoleClaim, IdentityUserToken<string>>
    {

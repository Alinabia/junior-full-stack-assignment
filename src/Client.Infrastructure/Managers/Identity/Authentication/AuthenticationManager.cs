...
using LeanTask.Client.Infrastructure.Routes;
using LeanTask.Shared.Constants.Storage;
    ...
    public class AuthenticationManager : IAuthenticationManager
    {
        ...
        public async Task<IResult> Login(TokenRequest model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                ((LeanStateProvider)this._authenticationStateProvider).MarkUserAsAuthenticated(model.Email);
        ...
        public async Task<IResult> Logout()
        {
            ...
            ((LeanStateProvider)_authenticationStateProvider).MarkUserAsLoggedOut();
